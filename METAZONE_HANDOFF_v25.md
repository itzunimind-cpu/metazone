...
**Version:** v39 — Session 39. vod.html: design-polish cleanup pass — toolbar reorganized into semantic groups, squad panel split into editor.html-style cards, all inline styles/onmouseover handlers removed in favor of CSS classes, hardcoded colors deduped into shared tokens, modal sizing/accent-color standardized. Presentation-only, no functional/JS logic changes.
...
| vod.html | v4.1 | Session 39 | Design-polish cleanup — toolbar grouped, squad panel split into cards, inline styles/onmouseover removed, modal size/color classes standardized. See Section 8 changelog. |
