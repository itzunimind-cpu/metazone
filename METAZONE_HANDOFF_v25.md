...
**Version:** v38 — Session 38. tournament-create.html: full parchment design-system migration — was still on the old dark-navy/cyan Phase 1 system. Now matches editor.html/index.html: header/nav, auth screen, left sidebar (resized to 268px to match editor/index left sidebar), removed glow box-shadows (CTA/progress-bar/mode-cards/event-card), removed decorative sync-badge and kernel/copyright system footer (anti-patterns), removed unused Tailwind CDN script and cyan grid-line body background.
...
| vod.html | v4.0 | Session 37 | Full parchment design-system migration — header/nav/auth/toast/modals/toolbar/squad-panel/calibration all match editor.html now. See Section 8 changelog. |
