...
**Version:** v37 — Session 37. vod.html: full parchment design-system migration — was still on the old dark-navy/cyan Phase 1 system, never updated. Now matches editor.html/index.html: header/nav, auth screen, toast system, squad panel (resized to 280px to match editor's right panel), toolbar, all modals, calibration tool, and timeline/canvas marker colors. All emoji replaced with iconify icons.
