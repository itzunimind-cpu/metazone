...
| editor.html | v7.1 | Session 41 | Pan/path-finish input overhaul — middle-mouse-drag pans in both modes, preview-mode left-click/touch pans directly (space+left-click removed), right-click now finishes a path (dblclick kept as fallback, replacing right-click's old implicit "show browser context menu mid-draw" behavior). See Section 8 changelog. |
